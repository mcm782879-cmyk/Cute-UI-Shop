...
export default function RegisterPage() {
  ...
  return (
    <div className="flex-1 flex items-center justify-center p-4 py-20 relative overflow-hidden bg-gray-50/50">
      <div className="absolute top-0 right-0 w-64 h-64 bg-secondary/10 rounded-full blur-3xl -z-10 transform translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 left-0 w-64 h-64 bg-primary/10 rounded-full blur-3xl -z-10 transform -translate-x-1/2 translate-y-1/2" />
      ...
      <Card className="w-full max-w-md rounded-[2rem] border-0 shadow-xl overflow-hidden bg-white/80 backdrop-blur-sm">
        ...
        <CardContent className="p-8 pt-0 space-y-6">
          ...
          >
            ...
            สมัคร / เข้าสู่ระบบด้วย Discord
          </Button>

          {/* Divider */}
          <div className="flex items-center gap-3">
            <div className="flex-1 h-px bg-gray-200" />
            <span className="text-xs text-gray-400 font-medium">หรือสมัครด้วย Email</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full h-12 rounded-xl font-bold bg-secondary hover:bg-secondary/90 text-white shadow-md mt-4"
